package com.yhdyy.ybserver.configurations;
...
@Configuration
@MapperScan(basePackages = "com.yhdyy.ybserver.daos.mssql",sqlSessionTemplateRef ="firstSqlSessionTemplate")
public class MssqlDataSourceConfig {
    ...
    /**本数据源扫描的mapper路径*/
    static final String MAPPER_LOCATION = "classpath:/com/yhdyy/ybserver/daos/mssql/*.xml";
